...
/**
 * <p>Classe Java per ArrayOfTopoService.typeGetCivicoChangeCivic complex type.
 * 
 ...
 *       <sequence>
 *         <element name="TopoService.typeGetCivicoChangeCivic" type="{http://schemas.datacontract.org/2004/07/WcfTopo}TopoService.typeGetCivicoChangeCivic" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class ArrayOfTopoServiceTypeGetCivicoChangeCivic {
     ...
     * This is why there is not a {@code set} method for the topoServiceTypeGetCivicoChangeCivic property.
     * 
     * <p>
