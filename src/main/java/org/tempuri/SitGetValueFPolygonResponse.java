 ...
 *       <sequence>
 *         <element name="sitGetValueFPolygonResult" type="{http://schemas.datacontract.org/2004/07/WcfTopo}TopoService.typeGetValue" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class SitGetValueFPolygonResponse {
    ...
    /**
     * Recupera il valore della proprietà sitGetValueFPolygonResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Imposta il valore della proprietà sitGetValueFPolygonResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TopoServiceTypeGetValue }{@code >}
