 ...
 *       <sequence>
 *         <element name="sitGetInfoResult" type="{http://schemas.datacontract.org/2004/07/WcfTopo}TopoService.typeGetInfo" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class SitGetInfoResponse {
    ...
    /**
     * Recupera il valore della proprietà sitGetInfoResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Imposta il valore della proprietà sitGetInfoResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TopoServiceTypeGetInfo }{@code >}
