...
public class SitGetData {
    ...
    @XmlElementRef(name = "pRiferimento", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    ...
    /**
     * Recupera il valore della propriet� pRiferimento.
     * 
     * @return
     *         possible object is
     *         {@link JAXBElement }{@code <}{@link String }{@code >}
    ...
    /**
     * Imposta il valore della propriet� pRiferimento.
     * 
     * @param value
     *              allowed object is
     *              {@link JAXBElement }{@code <}{@link String }{@code >}
