 ...
 *       <sequence>
 *         <element name="sitGetValueFidcResult" type="{http://schemas.datacontract.org/2004/07/WcfTopo}TopoService.typeGetValue" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class SitGetValueFidcResponse {
    ...
    /**
     * Recupera il valore della proprietà sitGetValueFidcResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Imposta il valore della proprietà sitGetValueFidcResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TopoServiceTypeGetValue }{@code >}
