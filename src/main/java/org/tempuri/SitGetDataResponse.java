 ...
 *       <sequence>
 *         <element name="sitGetDataResult" type="{http://schemas.datacontract.org/2004/07/WcfTopo}TopoService.typeGetData" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
public class SitGetDataResponse {
    ...
    /**
     * Recupera il valore della proprietà sitGetDataResult.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Imposta il valore della proprietà sitGetDataResult.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link TopoServiceTypeGetData }{@code >}
